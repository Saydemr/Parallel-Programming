...
main(int argc, char* argv[])
{
    ...
    printf("NUMTRIALS = %d BLOCKSIZE = %d PERFORMANCE = %6.4lf PROBABILITY = %3.10lf", NUMTRIALS, BLOCKSIZE, GigaTrials, (double)hits / (double)NUMTRIALS);
